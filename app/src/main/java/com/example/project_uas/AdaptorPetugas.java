...
public class AdaptorPetugas extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.nama_petugas = convertView.findViewById(R.id.nama_petugas);
        ...
        Toast.makeText(context,data.getNama_petugas(),Toast.LENGTH_SHORT).show();
        ...
        holder.editButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(context, EditDataActivityPetugas.class);
    ...
    private void deleteData(final String id_petugas, final int position) {
        String url = new Configurasi().baseUrl() + "petugas/hapus_petugas.php";
    ...
    private static class ViewHolder {
        TextView nama_petugas, jabatan, no_telpon;
